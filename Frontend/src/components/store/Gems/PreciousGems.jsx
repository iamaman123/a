    ...
    return (<>
      ...
      <section>
        ...
        <div className="container">
          {PreciousStone.map((gem, i) => (<div key={i} className="card">
              <div className="card-inner" style={{ "--clr": gem.iconBg }}>
                ...
                if (target.src !== "/Gems/center.webp") {
                  ...
                  <div className="icon">
                    <a href={`/store/gems/Product?id=${i + 1}`} className="iconBox" aria-label={`View ${gem.name}`} onClick={(event) => {
              ...
              <div className="content">
                ...
                <button className="buy-button" onClick={() => router.push(`/store/gems/Product?id=${i + 1}`)}>
                  Buy Now
                </button>
              </div>
            </div>))}
